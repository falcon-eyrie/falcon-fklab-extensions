...
public:
    ...
    enum AmplifierSampleRate {
        SampleRate1000Hz = 1000,
        SampleRate1250Hz = 1250,
        SampleRate1500Hz = 1500,
        SampleRate2000Hz = 2000,
        SampleRate2500Hz = 2500,
        SampleRate3000Hz = 3000,
        SampleRate3333Hz = 3333,
        SampleRate4000Hz = 4000,
        SampleRate5000Hz = 5000,
        SampleRate6250Hz = 6250,
        SampleRate8000Hz = 8000,
        SampleRate10000Hz = 10000,
        SampleRate12500Hz = 12500,
        SampleRate15000Hz = 15000,
        SampleRate20000Hz = 20000,
        SampleRate25000Hz = 25000,
        SampleRate30000Hz = 30000
    };
