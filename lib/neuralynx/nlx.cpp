...
std::vector<int32_t>::iterator NlxSignalRecord::data(
    std::vector<int32_t>::iterator it) const {
...
std::vector<double>::iterator NlxSignalRecord::data(
    std::vector<double>::iterator it) const {
