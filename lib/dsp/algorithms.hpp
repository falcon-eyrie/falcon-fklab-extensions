...
class RunningStatistics {
 public:
  RunningStatistics(double alpha,
                    uint64_t burn_in = 0,
                    bool outlier_protection = false,
                    double outlier_zscore = 3,
                    double outlier_half_life = 1,
                    double center = 0.0,
...
class RunningMeanMAD : public RunningStatistics {
 public:
  RunningMeanMAD(double alpha = 1.0,
...
class SpikeDetector {
 public:
  SpikeDetector(unsigned int nchannels,
                double threshold,
