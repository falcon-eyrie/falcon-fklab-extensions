...
static const unsigned int MAX_N_CHANNELS_SPIKE_DETECTION = 384;
...
static std::vector<unsigned int> zero_channels(MAX_N_SPIKES_IN_BUFFER * MAX_N_CHANNELS_SPIKE_DETECTION, 0);
