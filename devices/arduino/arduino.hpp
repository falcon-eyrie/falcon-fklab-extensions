...
class Arduino : public device::Device {
public:
...
class ArduinoDigitalOutAdapter : public device::DeviceAdapter<Arduino> {
public:
    ArduinoDigitalOutAdapter(device::Device & adaptee) : device::DeviceAdapter<Arduino>(adaptee) {}
};

class ArduinoDOInterface : public device::DeviceInterface<ArduinoDigitalOutAdapter,DigitalOut> {
