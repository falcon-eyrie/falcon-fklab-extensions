...
# the docs.  This file should be a Windows icons file (.ico) being 16x16 or 32x32
# pixels large.
#html_favicon = None
...
latex_documents = [
    (master_doc, 'Falcon.tex', u'Falcon Documentation',
     u'Fabian Kloosterman, Davide Ciliberti', 'manual'),
]
...
man_pages = [
    (master_doc, 'falcon', u'Falcon Documentation',
     [author], 1)
]
