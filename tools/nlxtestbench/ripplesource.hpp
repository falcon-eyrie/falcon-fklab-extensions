...
class RippleSource : public DataSource {
   public:
     ...
     * @param frequency frequency of the ripple should be contain between 150
     * and 250
     * @param ripple_duration Yaml Node containing duration of a ripple
     *        and zero interval value in msecs. The key specify for which
     * channel apply this set of parameters. If the key is *, apply it for all
     * channel.
     ...
     */
    RippleSource(double offset, double frequency, double sampling_rate, YAML::Node ripple_duration,
                 double mean_amplitude, double noise_stdev, bool convert_byte_order,
